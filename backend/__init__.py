...
from backend.config import (
    ...
    FACEBOOK_PIXEL_ID, GOOGLE_SITE_VERIFICATION, GOOGLE_ANALYTICS_ID, GOOGLE_TAG_MANAGER_ID, RENDER, site_origin,
...
def create_app(test_config=None):
    ...
    app.config['GOOGLE_TAG_MANAGER_ID'] = GOOGLE_TAG_MANAGER_ID
