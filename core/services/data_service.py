...
from core.config import DATA_FILE, site_origin, GOOGLE_SHEET_WEBHOOK_URL
        ...
        'sizes': [
            {
                ...
                'prices': [18000, 15000, 12000, 10000, 8000, 7000, 6000]
            },
            {
                'id': '7x11',
                'name': '7x11cm',
                'prices': [23000, 18000, 17000, 16000, 14000, 13000, 12000]
            },
            {
                'id': '9x12',
                'name': '9x12cm',
                'prices': [25000, 22000, 20000, 19000, 17000, 15000, 13000]
            },
            {
                'id': 'custom',
                'name': 'Ngoại size',
